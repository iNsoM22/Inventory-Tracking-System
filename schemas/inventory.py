...
class Inventory(Base):
    ...
    id: Mapped[int] = mapped_column(
        Integer, autoincrement=True, comment="Unique Surrogate Identifier.")
    product_id: Mapped[UUID] = mapped_column(
        UUID, ForeignKey("products.id"), primary_key=True, unique=True, comment="(F.Key) Unique identifier for the Product.")
